  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white-light">Section Details</h2>
          <p className="text-gray-600 dark:text-white-light">Manage sections in the hostel</p>
        </div>
          ...
          <table className="min-w-full divide-y divide-gray-200">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {filterData.map((section) => (
                <tr key={section.id} className="hover:bg-gray-50 dark:text-white-light dark:bg-black dark:hover:bg-gray-800">
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl max-w-md w-full border dark:border-white-light dark:bg-black">
